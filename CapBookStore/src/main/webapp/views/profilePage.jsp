...
<body>
	<div class="header1">
		...
		<div id="logout" class="header1">
			<a href="/"><img src="resources/images/lo.png" height="30" />
			</a>
		</div>
...
<button id="OpenImgUpload">Image Upload</button>
	...
	<div class="username"><font color="black">	${user.firstName } <br>${user.lastName }</font>
	</div>
	...
	<div class="aboutpad">
		...
		Address: ${user.address.state}<br>
		Address: ${user.address.country }<br>
		Address: ${user.address.zipCode }<br>
		Date of Birth: ${user.dob } <br>
		<a href="profileEdit"><input type="submit"  value="Edit"></a>
	</div>
