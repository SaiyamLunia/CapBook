...
<body>
	...
	<div class="cg-header">
		...
		<div id="form1" class="cg-header">
			Email or Phone<br> <input placeholder="Email" type="text"
				name="name" /><br> 
				<input type="checkbox" /> keep me logged in
		</div>

		<div id="form2" class="cg-header">
	...
	<div class="fb-body">
		<div id="intro1" class="cg-body">
			Capgemini helps you connect and share with the <br> people in
			your company.
		</div>
		<div id="intro2" class="cg-body">Create an account</div>
		<div id="img2" class="cg-body">
			<img src="resources/images/capgeminiLogo.png" />
		</div>
		<div id="intro3" class="cg-body">It's free and always will be.</div>
		<div id="form3" class="cg-body">
			First Name   <input placeholder="First Name" type="text" id="namebox" name="name1" /><br>
			Last Name   <input placeholder="Last Name" type="text" id="namebox" /> <br>
			Email<input placeholder="Email" type="text" id="mailbox" /><br> <br>
			Password<input placeholder="Password" type="password" id="mailbox" /><br>
			<input placeholder="Re-enter password" type="password" id="mailbox" />
			DateOfBirth<input type="date" id="namebox" /><br>
